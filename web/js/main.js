...
import { Terrain, SEA_FLOOR } from './terrain.js?v=0c7ecb87';
import { buildTerrain, buildRoads, buildBuildings, buildWater, buildAreas } from './worldgen.js?v=0c7ecb87';
import { buildStreetProps } from './props.js?v=0c7ecb87';
import { buildYards, buildStructures } from './yards.js?v=0c7ecb87';
import { buildFurniture } from './furniture.js?v=0c7ecb87';
import { buildLandmarks } from './landmarks.js?v=0c7ecb87';
import { buildSigns } from './signs.js?v=0c7ecb87';
import { audit } from './audit.js?v=0c7ecb87';
import { buildMap, drawMini, drawFull } from './minimap.js?v=0c7ecb87';
import { Collider, RoadIndex } from './collision.js?v=0c7ecb87';
import { Car, createCarMesh } from './vehicle.js?v=0c7ecb87';
...
async function boot() {
  try {
    ...
    furniture = await fetch('../data/furniture.json?v=0c7ecb87').then(r => r.json());
    landmarkDefs = await fetch('../data/landmarks.json?v=0c7ecb87').then(r => r.json()).catch(() => []);
