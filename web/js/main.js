...
import { Terrain, SEA_FLOOR } from './terrain.js?v=fcd256a8';
import { buildTerrain, buildRoads, buildBuildings, buildWater, buildAreas } from './worldgen.js?v=fcd256a8';
import { buildStreetProps } from './props.js?v=fcd256a8';
import { buildYards, buildStructures } from './yards.js?v=fcd256a8';
import { buildFurniture } from './furniture.js?v=fcd256a8';
import { buildLandmarks } from './landmarks.js?v=fcd256a8';
import { buildSigns } from './signs.js?v=fcd256a8';
import { audit } from './audit.js?v=fcd256a8';
import { buildMap, drawMini, drawFull } from './minimap.js?v=fcd256a8';
import { Collider, RoadIndex } from './collision.js?v=fcd256a8';
import { Car, createCarMesh } from './vehicle.js?v=fcd256a8';
...
async function boot() {
  try {
    ...
    furniture = await fetch('../data/furniture.json?v=fcd256a8').then(r => r.json());
    landmarkDefs = await fetch('../data/landmarks.json?v=fcd256a8').then(r => r.json()).catch(() => []);
