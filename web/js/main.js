...
import { Terrain, SEA_FLOOR } from './terrain.js?v=32918821';
import { buildTerrain, buildRoads, buildBuildings, buildWater, buildAreas } from './worldgen.js?v=32918821';
import { buildStreetProps } from './props.js?v=32918821';
import { buildYards, buildStructures } from './yards.js?v=32918821';
import { buildFurniture } from './furniture.js?v=32918821';
import { buildLandmarks } from './landmarks.js?v=32918821';
import { buildSigns } from './signs.js?v=32918821';
import { audit } from './audit.js?v=32918821';
import { buildMap, drawMini, drawFull } from './minimap.js?v=32918821';
import { Collider, RoadIndex } from './collision.js?v=32918821';
import { Car, createCarMesh } from './vehicle.js?v=32918821';
...
async function boot() {
  try {
    ...
    furniture = await fetch('../data/furniture.json?v=32918821').then(r => r.json());
    landmarkDefs = await fetch('../data/landmarks.json?v=32918821').then(r => r.json()).catch(() => []);
