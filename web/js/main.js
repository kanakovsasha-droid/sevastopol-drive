...
import { Terrain, SEA_FLOOR } from './terrain.js?v=668a4f38';
import { buildTerrain, buildRoads, buildBuildings, buildWater, buildAreas } from './worldgen.js?v=668a4f38';
import { buildStreetProps } from './props.js?v=668a4f38';
import { buildYards, buildStructures } from './yards.js?v=668a4f38';
import { buildFurniture } from './furniture.js?v=668a4f38';
import { buildLandmarks } from './landmarks.js?v=668a4f38';
import { buildSigns } from './signs.js?v=668a4f38';
import { audit } from './audit.js?v=668a4f38';
import { buildMap, drawMini, drawFull } from './minimap.js?v=668a4f38';
import { Collider, RoadIndex } from './collision.js?v=668a4f38';
import { Car, createCarMesh } from './vehicle.js?v=668a4f38';
...
async function boot() {
  try {
    ...
    furniture = await fetch('../data/furniture.json?v=668a4f38').then(r => r.json());
    landmarkDefs = await fetch('../data/landmarks.json?v=668a4f38').then(r => r.json()).catch(() => []);
