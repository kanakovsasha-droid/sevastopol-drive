...
import { Terrain, SEA_FLOOR } from './terrain.js?v=85214ac5';
import { buildTerrain, buildRoads, buildBuildings, buildWater, buildAreas } from './worldgen.js?v=85214ac5';
import { buildStreetProps } from './props.js?v=85214ac5';
import { buildYards, buildStructures } from './yards.js?v=85214ac5';
import { buildFurniture } from './furniture.js?v=85214ac5';
import { buildLandmarks } from './landmarks.js?v=85214ac5';
import { buildSigns } from './signs.js?v=85214ac5';
import { audit } from './audit.js?v=85214ac5';
import { buildMap, drawMini, drawFull } from './minimap.js?v=85214ac5';
import { Collider, RoadIndex } from './collision.js?v=85214ac5';
import { Car, createCarMesh } from './vehicle.js?v=85214ac5';
...
async function boot() {
  try {
    ...
    furniture = await fetch('../data/furniture.json?v=85214ac5').then(r => r.json());
    landmarkDefs = await fetch('../data/landmarks.json?v=85214ac5').then(r => r.json()).catch(() => []);
