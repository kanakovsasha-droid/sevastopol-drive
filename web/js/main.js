...
import { Terrain, SEA_FLOOR } from './terrain.js?v=4920fe70';
import { buildTerrain, buildRoads, buildBuildings, buildWater, buildAreas } from './worldgen.js?v=4920fe70';
import { buildStreetProps } from './props.js?v=4920fe70';
import { buildYards, buildStructures } from './yards.js?v=4920fe70';
import { buildFurniture } from './furniture.js?v=4920fe70';
import { buildLandmarks } from './landmarks.js?v=4920fe70';
import { buildSigns } from './signs.js?v=4920fe70';
import { audit } from './audit.js?v=4920fe70';
import { buildMap, drawMini, drawFull } from './minimap.js?v=4920fe70';
import { Collider, RoadIndex } from './collision.js?v=4920fe70';
import { Car, createCarMesh } from './vehicle.js?v=4920fe70';
...
async function boot() {
  try {
    ...
    furniture = await fetch('../data/furniture.json?v=4920fe70').then(r => r.json());
    landmarkDefs = await fetch('../data/landmarks.json?v=4920fe70').then(r => r.json()).catch(() => []);
